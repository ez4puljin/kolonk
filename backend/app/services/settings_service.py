...
DEFAULT_SETTINGS: dict[str, Any] = {
    ...
    # ПОС борлуулалт (Талбай/Дэлгүүр/Төлбөр) ашиглах эсэх. Унтраалттай үед
    # түгээгч ээлжээ бэлэн мөнгө + милийн зурагтай нээж, орой өдрийн хаалтаар
    # бүх борлуулалт, зээл, зарлагаа нэг дор бүртгэнэ. Станц түгээгчийн
    # горимоор ажилладаг тул шинэ суулгалт үүгээр эхэлнэ; ПОС хэрэгтэй бол
    # Тохиргооноос асаана.
    "pos_sales_enabled": False,
    # --- Дата backup ---
    ...
    "gdrive_last_error": "",
    # Drive руу сүүлд амжилттай байршуулсан зургийн архивын хурууны хээ.
    "gdrive_uploads_fingerprint": "",
    # --- Цалингийн тооцоо ---
