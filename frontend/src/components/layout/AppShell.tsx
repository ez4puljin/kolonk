...
const NAV: readonly NavSection[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { to: "/vouchers", label: t.nav.vouchers, icon: Ticket, permissions: ["instruments.manage"] },
      { to: "/prepaid", label: t.nav.prepaid, icon: CreditCard, permissions: ["instruments.manage"] },
    ],
  },
  {
    key: "finance",
